var login=Vue.extend({
      ...
      created:function(){
        ...
        methods:{
          ...
          // 设置cookie
          // setCookie:function(this.findItem.username,this.findItem.password){
          //   var name=new Username();
          //   name.setTime(name.getTime()+(60*100));

          // }
       }

      //  document.cookie='username='+this.findItem.username;
      // //读取cookie
      // var username=document.cookie.spilt(';')[0].spilt('=')[1];
      // setCookie:function(name,value){
      //   var username=new Username();
      //   username.setTime(name.get)
      }
